class SeedsController < ApplicationController
  ...
  def search
      ...
      @seeds_by_common_name = Seed.find_all_like_common_name(@query)
      @seeds_by_scientific_name = Seed.find_all_like_scientific_name(@query)
      @seeds_by_hardiness_zone = Seed.find_all_in_hardiness_zone(@query)
  end
end
